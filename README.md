...
* The Clinical School
  ...
  * Various tips
    ...
    * [New VPN client settings](https://confluence.medschl.cam.ac.uk/display/FAQ/New+VPN+Client+settings+for+Biomedical+Campus) from April 18/19, 2021, which uses Remote Gateway `vpn.medschl.cam.ac.uk` and Customize port 10443.
* The University
